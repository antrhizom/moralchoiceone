export default function FeedbackScreen({ decisions, setStage, dilemmata, showModal, setShowModal }) {
  const lastDecision = decisions[decisions.length - 1];
  
  return (
    <div className="min-h-screen flex items-center justify-center p-4 py-12">
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-xl p-8 fade-in">
